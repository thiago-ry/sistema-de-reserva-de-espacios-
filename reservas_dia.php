...
// Botón "Reservar" SIEMPRE visible y con parámetros correctos
echo "<div style='margin-top: 20px; text-align: right;'>";
echo "<a href='agregar_reserva.php?fecha=" . urlencode($fecha) . "&espacio_id=" . $espacio_id . "' 
        style='background:#004080; color:white; padding:10px 20px; text-decoration:none; border-radius:5px;'>
        Reservar
      </a>";
echo "</div>";
?>
